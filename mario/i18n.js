...
const STR = {
  ...
  aboutLinkSub:{ pt: 'Quem vai te guiar', en: 'Who will guide you' },
  hubTransfer:    { pt: 'Transfer com motorista', en: 'Transfer with a driver' },
  hubTransferSub: { pt: 'Aeroporto, porto, estações — veja o valor na hora', en: 'Airport, port, stations — see the price now' },
  hubRoteiro:     { pt: 'Monte seu roteiro', en: 'Plan your own trip' },
  hubRoteiroSub:  { pt: 'Conte o que você quer e eu monto com você', en: 'Tell me what you want and I will plan it with you' },
  hubWhatsSub:    { pt: 'Resposta direta comigo', en: 'Talk to me directly' },
  hubViagem:      { pt: 'Para a sua viagem', en: 'For your trip' },
  hubRedes:       { pt: 'Me acompanhe', en: 'Follow me' },
  nParadas:    { pt: '{n} paradas', en: '{n} stops' },
  secStops:    { pt: 'O roteiro, parada por parada', en: 'The route, stop by stop' },
  secStopsSub: { pt: '{n} paradas · {d} com {guia}', en: '{n} stops · {d} with {guia}' },
  apRedes:    { pt: 'Suas redes', en: 'Your social links' },
  apRedesWhy: { pt: 'Aparecem como ícones no topo da primeira tela. Em branco, o ícone some.', en: 'Shown as icons at the top of the first screen. Leave blank to hide.' },
  apLinks:    { pt: 'Links de parceiros', en: 'Partner links' },
  apLinksWhy: { pt: 'Os links que hoje estão no seu Beacons: hotel, chip, seguro. Aparecem em "Para a sua viagem", na primeira tela. Use o seu link de parceira — é dele que vem a comissão.',
                en: 'The links in your Beacons today: hotel, SIM, insurance. Shown under "For your trip" on the first screen. Use your partner link — that is where the commission comes from.' },
  apLinkAdd:  { pt: '+ link', en: '+ link' },
  apIcone:    { pt: 'Ícone', en: 'Icon' },
  apTitulo:   { pt: 'Título', en: 'Title' },
  apSub:      { pt: 'Linha de baixo', en: 'Subtitle' },
  apRegs:     { pt: 'Cidades e regiões', en: 'Cities and regions' },
  apRegsWhy:  { pt: 'Organizam a vitrine: o cliente escolhe "Munique", "Baviera", "Áustria"… Acrescente uma cidade nova e depois escolha ela no passeio.',
                en: 'They organise the showcase: guests pick "Munich", "Bavaria", "Austria"… Add a new city, then pick it on the tour.' },
  apRegAdd:   { pt: '+ cidade ou região', en: '+ city or region' },
  apRegNome:  { pt: 'Nome', en: 'Name' },
  apRegUsos:  { pt: 'passeios usam', en: 'tours use it' },
  apSalvar:   { pt: 'Salvar primeira tela', en: 'Save first screen' },
  apSalvo:    { pt: 'Salvo.', en: 'Saved.' },
  admWise:    { pt: 'Link de pagamento Wise', en: 'Wise payment link' },
  admWiseHelp:{ pt: 'O link que a Wise gera para você receber (wise.com/pay/…). O cliente abre e paga em real ou euro.', en: 'The link Wise gives you to get paid (wise.com/pay/…). The guest opens it and pays in reais or euros.' },
  admCash:    { pt: 'Aceito dinheiro no dia', en: 'I accept cash on the day' },
  admCashHelp:{ pt: 'Aparece como opção para o cliente. Útil no transfer: sinal antes, o resto em dinheiro com o motorista.', en: 'Shown to the guest as an option. Handy for transfers: deposit first, the rest in cash with the driver.' },
  wiseLbl:    { pt: 'Pagar pela Wise', en: 'Pay with Wise' },
  wiseAbrir:  { pt: 'Abrir a Wise', en: 'Open Wise' },
  cashLbl:    { pt: 'Também aceito dinheiro no dia.', en: 'Cash on the day is also accepted.' },
  rtTit:      { pt: 'Monte seu roteiro', en: 'Plan your own trip' },
  rtIntro:    { pt: 'Conte como é a sua viagem e o que você gosta. Eu recebo tudo no WhatsApp e monto uma proposta sob medida para vocês.',
                en: 'Tell me about your trip and what you enjoy. I get it all on WhatsApp and put together a proposal just for you.' },
  rtQuando:   { pt: 'Quando', en: 'When' },
  rtChega:    { pt: 'Chegada', en: 'Arrival' },
  rtSai:      { pt: 'Partida', en: 'Departure' },
  rtQuem:     { pt: 'Quem vem', en: 'Who is coming' },
  rtIdades:   { pt: 'Idade das crianças', en: 'Children’s ages' },
  rtIdadesPh: { pt: 'ex.: 4 e 9 anos', en: 'e.g. 4 and 9' },
  rtOnde:     { pt: 'Onde você quer ir', en: 'Where you want to go' },
  rtVarios:   { pt: 'Pode marcar mais de um.', en: 'Pick as many as you like.' },
  rtOndeOutro:{ pt: 'Outro lugar?', en: 'Somewhere else?' },
  rtGosto:    { pt: 'O que vocês gostam', en: 'What you enjoy' },
  rtRitmo:    { pt: 'Ritmo da viagem', en: 'Pace' },
  rtPrecisa:  { pt: 'Precisa de ajuda com', en: 'Need help with' },
  rtConte:    { pt: 'Conte mais', en: 'Tell me more' },
  rtContePh:  { pt: 'Uma data especial, um lugar que é sonho antigo, alguém com dificuldade para andar…',
                en: 'A special date, a long-held dream, someone with limited mobility…' },
  rtVoce:     { pt: 'Seus dados', en: 'Your details' },
  rtEnviar:   { pt: 'Enviar para {guia} no WhatsApp', en: 'Send to {guia} on WhatsApp' },
  rtFine:     { pt: 'Não é uma reserva e não tem compromisso: é o começo da conversa.', en: 'This is not a booking and there is no commitment: it starts the conversation.' },
  rtFalta:    { pt: 'Preencha seu nome e WhatsApp.', en: 'Fill in your name and WhatsApp.' },
  rtOk:       { pt: 'Pedido enviado!', en: 'Request sent!' },
  rtOkSub:    { pt: 'O WhatsApp abriu com tudo preenchido — é só tocar em enviar. {guia} responde com a proposta.',
                en: 'WhatsApp opened with everything filled in — just tap send. {guia} will reply with a proposal.' },
  rtReenviar: { pt: 'Abrir o WhatsApp de novo', en: 'Open WhatsApp again' },
  pdTit:      { pt: 'Pedidos de roteiro', en: 'Trip requests' },
  pdVazio:    { pt: 'Quando alguém preencher "Monte seu roteiro", o pedido aparece aqui.', en: 'When someone fills in "Plan your own trip", it shows up here.' },
  pdResp:     { pt: 'Respondido', en: 'Answered' },
  pdNovo:     { pt: 'Novo', en: 'New' },
  pdMarca:    { pt: 'Marcar como respondido', en: 'Mark as answered' },
  pdDesmarca: { pt: 'Voltar para novo', en: 'Mark as new' },
  pdAbrir:    { pt: 'Responder no WhatsApp', en: 'Reply on WhatsApp' },
  aboutTitle:  { pt: 'Prazer, sou {guia}', en: "Hi, I'm {guia}" },
  aboutBased:  { pt: 'Baseada em', en: 'Based in' },
  aboutLangs:  { pt: 'Português · Inglês', en: 'Portuguese · English' },
  ...
  fPapal:    { pt: 'Audiência Papal', en: 'Papal Audience' },
  fTrem:     { pt: 'De trem', en: 'By train' },
  fConexao:  { pt: 'Conexão e cruzeiro', en: 'Layover & cruise' },
  fBarco:    { pt: 'De barco', en: 'By boat' },
  ondeTodos: { pt: 'Todos', en: 'All' },
  fCarro:    { pt: 'De carro', en: 'By car' },
  tCarro:    { pt: 'Panorâmica de carro', en: 'Panoramic by car' },
  ...
  edTable:     { pt: 'Sua tabela de valores', en: 'Your price table' },
  edTableWhy:  { pt: 'O valor fechado do grupo para cada quantidade de pessoas. Deixe em branco a partir de onde você prefere combinar a mão — ali o app manda a pessoa falar com você em vez de inventar um preço.',
                 en: 'The closed group price for each number of people. Leave blank from the point where you would rather quote by hand — there the app sends the person to you instead of inventing a price.' },
  edTablePax:  { pt: '{n} pess.', en: '{n} ppl' },
  vTable:      { pt: 'Preencha ao menos o valor para 1 pessoa.', en: 'Fill in at least the price for 1 person.' },
  vTrf:        { pt: 'A tabela do transfer precisa de pelo menos uma linha com valor.', en: 'The transfer table needs at least one row with a price.' },
  perTransfer: { pt: 'Transfer (tabela por pessoas e veículo)', en: 'Transfer (table by people and vehicle)' },
  tPaySinal:   { pt: 'Sinal agora, restante no dia', en: 'Deposit now, rest on the day' },
  edTrf:       { pt: 'Tabela do transfer', en: 'Transfer price table' },
  edTrfWhy:    { pt: 'Como na sua tabela: quantas pessoas, o veículo, quantas malas cabem, o valor de dia, o noturno (21h às 5h59) e o sinal. Duas linhas com o mesmo número de pessoas viram as duas opções que o cliente escolhe.',
                 en: 'As in your table: people, vehicle, luggage, day price, night price (21:00–5:59) and deposit. Two rows with the same number of people become the two options the guest chooses from.' },
  edTrfPax:    { pt: 'Pessoas', en: 'People' },
  edTrfVeic:   { pt: 'Veículo', en: 'Vehicle' },
  ...
  edIngWhy:    { pt: 'Como no seu PDF. Ex.: Castelo Neuschwanstein — grátis até 17 anos, inteiro €21. Adulto paga o inteiro. "Da guia" é o seu ingresso, cobrado uma vez. "No dia" aparece para o cliente mas fica fora do total.',
                 en: 'As in your PDF. E.g. Neuschwanstein Castle — free up to 17, full €21. Adults pay full. "Guide" is your own ticket, charged once. "On the day" is shown but left out of the total.' },
  ...
  edIdadeMinWhy:{ pt: 'Opcional. Aparece para o cliente na hora de reservar.', en: 'Optional. Shown to the guest when booking.' },
  person:      { pt: 'pessoa', en: 'person' },
  perTrip:     { pt: 'por trecho', en: 'per trip' },
  grpTitle:    { pt: 'Quem mais vem', en: 'Who else is coming' },
  grpWhy:      { pt: 'Nome e data de nascimento de cada pessoa do grupo. Ajuda na reserva dos ingressos e no seguro — e você não precisa mandar depois por WhatsApp.',
                 en: 'Name and date of birth for everyone in the group. It helps with ticket bookings and insurance — and saves you sending it later on WhatsApp.' },
  grpName:     { pt: 'Nome e sobrenome', en: 'Full name' },
  grpBirth:    { pt: 'Nascimento', en: 'Date of birth' },
  grpAdd:      { pt: '+ acrescentar pessoa', en: '+ add a person' },
  grpCameWith: { pt: 'veio com {n}', en: 'came with {n}' },
  grpInBooking:{ pt: 'No grupo', en: 'In the group' },
  trfTable:    { pt: 'Valores por trecho', en: 'Price per trip' },
  trfCar:      { pt: 'Carro', en: 'Car' },
  trfVan:      { pt: 'Minivan', en: 'Minivan' },
  trfDay:      { pt: 'Dia', en: 'Day' },
  trfNight:    { pt: 'Noite', en: 'Night' },
  trfHours:    { pt: 'Dia: 6h às 20h59 · Noite: 21h às 5h59', en: 'Day: 6:00–20:59 · Night: 21:00–5:59' },
  trfPick:     { pt: 'Escolha o veículo', en: 'Choose the vehicle' },
  trfPax12:    { pt: '1 ou 2 pessoas', en: '1 or 2 people' },
  trfPaxN:     { pt: '{n} pessoas', en: '{n} people' },
  trfColQuem:  { pt: 'Pessoas · veículo e malas', en: 'People · vehicle and luggage' },
  trfSinalTabela: { pt: 'Para garantir o transfer, paga-se um sinal (de €30 a €230, conforme o grupo). O restante é pago no dia.',
                    en: 'A deposit (from €30 to €230, depending on the group) secures the transfer. The rest is paid on the day.' },
  trfSinalLbl: { pt: 'Sinal para garantir', en: 'Deposit to secure it' },
  trfSinalNota:{ pt: 'Agora você paga só o sinal, {s}. O restante, {r}, é pago no dia do transfer.',
                 en: 'You pay only the deposit now, {s}. The rest, {r}, is paid on the day.' },
  trfRestoDia: { pt: 'O restante, {v}, é pago no dia do transfer.', en: 'The rest, {v}, is paid on the day of the transfer.' },
  trfCentroQ:  { pt: 'O hotel fica no centro histórico, e é uma parada só?', en: 'Is the hotel in the historic centre, with a single stop?' },
  trfCentroWhy:{ pt: 'Se o hotel for fora do centro, ou o grupo se dividir em dois hotéis, {guia} faz o orçamento na hora pelo WhatsApp.',
                 en: 'If the hotel is outside the centre, or the group splits between two hotels, {guia} will quote it on WhatsApp.' },
  ...
  ingAviso:    { pt: 'Ingressos pelo valor mínimo: com pouca disponibilidade eles podem subir. {guia} confirma o valor antes de comprar.',
                 en: 'Tickets at the minimum price: with low availability they can go up. {guia} confirms before buying.' },
  adultsLbl:   { pt: 'Adultos', en: 'Adults' },
  adultsSub:   { pt: '18 anos ou mais', en: '18 or older' },
  kidsLbl:     { pt: 'Crianças', en: 'Children' },
  kidsSub:     { pt: 'menores de 18', en: 'under 18' },
  noKids:      { pt: 'Este passeio é só para maiores de 18 anos.', en: 'This tour is for adults only (18+).' },
  minAge:      { pt: 'Idade mínima: {n} anos.', en: 'Minimum age: {n}.' },
  orcOi:       { pt: 'Olá, {guia}! Queria um orçamento:', en: 'Hi {guia}! I would like a quote:' },
  orcQuem:     { pt: '{n} pessoas', en: '{n} people' },
  orcQuemCri:  { pt: '{a} adultos e {c} crianças', en: '{a} adults and {c} children' },
  orcForaCentro:{ pt: 'O hotel é fora do centro histórico (ou tem mais de uma parada).', en: 'The hotel is outside the historic centre (or there is more than one stop).' },
  trfPickWhy:  { pt: 'As duas opções levam o seu grupo — o que muda é quanta bagagem cabe.', en: 'Both options fit your group — what changes is how much luggage fits.' },
  trfNightOn:  { pt: 'Horário noturno', en: 'Night rate' },
  priceTable:  { pt: 'Valor por número de pessoas', en: 'Price by group size' },
  priceTableHelp: { pt: 'O valor é fechado para o grupo todo, não por pessoa.',
                    en: 'The price is for the whole group, not per person.' },
  closedPrice: { pt: '{n} pessoas · valor fechado', en: '{n} people · closed price' },
  bigGroup:    { pt: 'Grupo com mais de {n} pessoas: me chame que eu faço um valor.',
                 en: 'Groups over {n} people: message me for a quote.' },
  bigGroupBtn: { pt: 'Pedir valor no WhatsApp', en: 'Ask for a quote on WhatsApp' },
  ...
  step2trf:    { pt: '2 de 4 · qual veículo', en: '2 of 4 · which vehicle' },
  ...
  /* Sem data, o cliente batia num beco. A proprio guia escreve nos PDFs
  ...
  waAskDates: { pt: 'Oi {guia}! Vi o passeio {tour} no seu app e queria saber as próximas datas 🙂',
                en: 'Hi {guia}! I saw {tour} on your app and would like to know the next dates 🙂' },
  ...
  /* ---- situacao do pagamento, sempre com a conta inteira ----
     ...
     entrado alguma coisa. O guia nao conseguia saber, olhando a lista,
  ...
  msgGuia:  { pt: 'Falar com {guia}', en: 'Message {guia}' },
  ...
  goodMorning:{ pt: 'Bom dia, {guia}', en: 'Good morning, {guia}' },
  ...
  tDay: { pt: 'Dia inteiro, com motorista', en: 'Full day, with driver' },
  tTransfer: { pt: 'Transfer', en: 'Transfer' },
  tPapal:    { pt: 'Audiência Papal', en: 'Papal Audience' },
  tTrem:     { pt: 'Bate e volta de trem', en: 'Day trip by train' },
  tConexao:  { pt: 'Conexão / parada de cruzeiro', en: 'Layover / cruise stop' },
  tBarco:    { pt: 'Passeio de barco', en: 'Boat tour' },
  ...
  pgOk:         { pt: 'Recebemos seu pagamento. Sua reserva <b>{code}</b> está garantida — {guia} já recebeu o aviso.',
                  en: 'We received your payment. Your booking <b>{code}</b> is secured — {guia} has been notified.' },
  pgDuvidaTit:  { pt: 'Ainda não consegui confirmar', en: 'Could not confirm yet' },
  pgDuvida:     { pt: 'Se o valor saiu do seu cartão, está tudo certo — às vezes o banco demora alguns minutos. Guarde o código <b>{code}</b> e, se quiser, fale com {guia}.',
                  en: 'If your card was charged, you are fine — banks sometimes take a few minutes. Keep the code <b>{code}</b> and reach out to {guia} if you like.' },
  ...
  emAssina: { pt: '“{guia} · {negocio} · {base}”',
              en: '“{guia} · {negocio} · {base}”' },
  ...
  edClosingWhy:{ pt: 'A última coisa que a pessoa lê antes de decidir. Uma frase sua, não um slogan.',
  ...
  consentLbl:  { pt: 'Quero receber as novidades de {guia} por e-mail e WhatsApp', en: "I'd like to hear from {guia} by email and WhatsApp" },
  ...
  /* conta de {guia} */
  loginTitle:  { pt: 'Área de {guia}', en: "{guia}'s area" },
  ...
  loginHi:     { pt: 'Que bom te ver de volta, {guia}.', en: 'Welcome back, {guia}.' },
  ...
  /* whatsapp */
  waHello:   { pt: 'Oi {guia}! Vi seu app de passeios e quero saber mais 🙂', en: 'Hi {guia}! I found your tours app and would love to know more 🙂' },
  waSendBooking: { pt: 'Me apresentar no WhatsApp de {guia}', en: 'Say hi on {guia}’s WhatsApp' },
  waBookingMsg: { pt: 'Oi {guia}! Acabei de reservar: {tour}, {when}. Meu código é {code}. Sou {name} 🙂', en: 'Hi {guia}! I just booked: {tour}, {when}. My code is {code}. I’m {name} 🙂' },
  waHi:      { pt: 'Oi {name}! Aqui é {guia} 🙂 Sobre o seu passeio {tour}, {when} — está tudo certo por aí?', en: 'Hi {name}! {guia} here 🙂 About your {tour} on {when} — all good on your end?' },
  waCharge:  { pt: 'Oi {name}! Aqui é {guia} 🙂 Faltam {v} do passeio {tour} ({when}). Consegue acertar por aqui? Agradeço!', en: 'Hi {name}! {guia} here 🙂 {v} is still due for {tour} ({when}). Could you settle it here? Thank you!' },
...
function t(key, vars) {
  ...
  if (typeof guiaNome === 'function' && s.includes('{'))
    s = s.replaceAll('{guia}', guiaNome()).replaceAll('{negocio}', guiaNegocio()).replaceAll('{base}', guiaBase());
  return s;
}
