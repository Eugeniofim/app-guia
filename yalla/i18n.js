...
const STR = {
  ...
  rpInt:       { pt: 'Interesse × reservas', en: 'Interest vs. bookings', fr: 'Intérêt et réservations', it: 'Interesse e prenotazioni', de: 'Interesse und Buchungen', es: 'Interés y reservas' },
  rpIntHelp:   { pt: 'Quantas vezes abriram cada passeio, quantos chegaram a escolher data e quantos reservaram de verdade.', en: 'How many times each tour was opened, how many picked a date and how many actually booked.', fr: 'Combien de fois chaque visite a été ouverte, combien ont choisi une date et combien ont réservé.', it: 'Quante volte ogni tour è stato aperto, quanti hanno scelto una data e quanti hanno prenotato.', de: 'Wie oft jede Tour geöffnet wurde, wie viele ein Datum wählten und wie viele buchten.', es: 'Cuántas veces abrieron cada tour, cuántos eligieron fecha y cuántos reservaron.' },
  rpIntCols:   { pt: ['Passeio', 'Visitas', 'Quase', 'Reservas', 'Conversão', 'Receita'], en: ['Tour', 'Views', 'Almost', 'Bookings', 'Conversion', 'Revenue'], fr: ['Visite', 'Vues', 'Presque', 'Réservations', 'Conversion', 'Recettes'], it: ['Tour', 'Visite', 'Quasi', 'Prenotazioni', 'Conversione', 'Ricavi'], de: ['Tour', 'Aufrufe', 'Fast', 'Buchungen', 'Conversion', 'Umsatz'], es: ['Tour', 'Visitas', 'Casi', 'Reservas', 'Conversión', 'Ingresos'] },
  rpIntVisto:  { pt: '👀 O mais procurado é “{tour}”, com {n} visitas.', en: '👀 The most viewed is “{tour}”, with {n} views.', fr: '👀 La plus consultée est « {tour} », avec {n} vues.', it: '👀 Il più visto è “{tour}”, con {n} visite.', de: '👀 Am meisten angesehen: „{tour}“, mit {n} Aufrufen.', es: '👀 El más visto es “{tour}”, con {n} visitas.' },
  rpIntVende:  { pt: '💰 O que mais rende é “{tour}”, com {v} no período.', en: '💰 The top earner is “{tour}”, with {v} in the period.', fr: '💰 Celle qui rapporte le plus est « {tour} », avec {v} sur la période.', it: '💰 Quello che rende di più è “{tour}”, con {v} nel periodo.', de: '💰 Am meisten bringt „{tour}“ ein: {v} im Zeitraum.', es: '💰 El que más rinde es “{tour}”, con {v} en el período.' },
  rpIntConv:   { pt: '🎯 Quem abre “{tour}” é quem mais reserva ({p}%).', en: '🎯 People who open “{tour}” book the most ({p}%).', fr: '🎯 Ceux qui ouvrent « {tour} » réservent le plus ({p} %).', it: '🎯 Chi apre “{tour}” prenota di più ({p}%).', de: '🎯 Wer „{tour}“ öffnet, bucht am häufigsten ({p} %).', es: '🎯 Quien abre “{tour}” es quien más reserva ({p}%).' },
  rpIntVitrine:{ pt: '⚠️ “{tour}” teve {n} visitas e nenhuma reserva — vale rever preço, fotos ou datas.', en: '⚠️ “{tour}” had {n} views and no bookings — worth reviewing price, photos or dates.', fr: '⚠️ « {tour} » a eu {n} vues et aucune réservation — revoyez prix, photos ou dates.', it: '⚠️ “{tour}” ha avuto {n} visite e nessuna prenotazione — rivedi prezzo, foto o date.', de: '⚠️ „{tour}“ hatte {n} Aufrufe und keine Buchung — Preis, Fotos oder Termine prüfen.', es: '⚠️ “{tour}” tuvo {n} visitas y ninguna reserva — conviene revisar precio, fotos o fechas.' },
  admDica:     { pt: 'Isto é o que o seu cliente vê. O seu painel, onde você controla tudo, fica aqui ', en: 'This is what your guest sees. Your panel, where you run everything, is right here ', fr: 'Voici ce que voit votre client. Votre panneau, où vous gérez tout, est ici ', it: 'Questo è ciò che vede il cliente. Il tuo pannello, dove gestisci tutto, è qui ', de: 'Das sieht dein Gast. Dein Panel, wo du alles steuerst, ist hier ', es: 'Esto es lo que ve tu cliente. Tu panel, donde controlas todo, está aquí ' },
  persLink:    { pt: 'Monte a sua experiência', en: 'Design your experience' },
  persLinkSub: { pt: 'Roteiro sob medida nos Emirados', en: 'A tailor-made itinerary in the UAE' },
  ...
  persTit:     { pt: 'Monte a sua experiência', en: 'Design your experience' },
  persIntro:   { pt: 'Cada experiência da Yalla é montada sob medida. Me conte quem vem, quando e o que vocês querem viver — eu desenho o roteiro, cuido dos parceiros locais e volto com a proposta.', en: 'Every Yalla experience is tailor-made. Tell me who is coming, when, and what you want to live — I design the itinerary, handle the local partners and come back with a proposal.' },
  ...
  persObsPh:   { pt: 'Aniversário na viagem, restrição alimentar, alguém com dificuldade de andar, o que vocês sonham ver…', en: 'A birthday during the trip, dietary needs, limited mobility, what you dream of seeing…' },
  persEnviar:  { pt: 'Enviar para a Milla no WhatsApp', en: 'Send to Milla on WhatsApp' },
  persRodape:  { pt: 'Sem compromisso. Eu leio, desenho a experiência e volto com a proposta.', en: 'No commitment. I read it, design the experience and come back with a proposal.' },
  persEnviado: { pt: 'Pronto! Vou te responder por lá 😊', en: 'Done! I will reply there 😊' },
  persMsgOi:   { pt: 'Oi Milla! Quero montar um roteiro com você. {nome}', en: 'Hi Milla! I would like to plan a trip with you. {nome}' },
  persMsgQuem: { pt: '{a} adultos e {c} crianças', en: '{a} adults and {c} children' },
  sobConsulta:    { pt: 'Sob consulta', en: 'On request' },
  sobConsultaSub: { pt: 'cada experiência é montada sob medida', en: 'every experience is tailor-made' },
  sobConsultaTit: { pt: 'Vamos desenhar a sua experiência', en: 'Let’s design your experience' },
  sobConsultaTxt: { pt: 'Me conte quantas pessoas, as datas e o que você quer viver. Em seguida eu volto com a proposta e os valores.', en: 'Tell me how many people, the dates and what you want to experience. I’ll come back with the proposal and the price.' },
  waFalar:        { pt: 'Falar no WhatsApp', en: 'Message on WhatsApp' },
  waSobConsulta:  { pt: 'Olá, Milla! Vim pelo app e quero saber mais sobre: {tour}', en: 'Hi Milla! I came from the app and I’d like to know more about: {tour}' },
  sobConsulta:    { pt: 'Sob consulta', en: 'On request', fr: 'Sur demande', it: 'Su richiesta', de: 'Auf Anfrage', es: 'A consultar' },
  sobConsultaSub: { pt: 'cada experiência é montada sob medida', en: 'every experience is tailor-made', fr: 'chaque expérience est sur mesure', it: 'ogni esperienza è su misura', de: 'jede Erfahrung ist maßgeschneidert', es: 'cada experiencia es a medida' },
  sobConsultaTit: { pt: 'Vamos desenhar a sua experiência', en: 'Let’s design your experience', fr: 'Concevons votre expérience', it: 'Progettiamo la tua esperienza', de: 'Lass uns dein Erlebnis gestalten', es: 'Diseñemos tu experiencia' },
  sobConsultaTxt: { pt: 'Me conte quantas pessoas, as datas e o que você quer viver. Em seguida eu volto com a proposta e os valores.', en: 'Tell me how many people, the dates and what you want to experience. I’ll come back with the proposal and the price.', fr: 'Dites-moi combien de personnes, les dates et ce que vous voulez vivre. Je reviens avec la proposition et les tarifs.', it: 'Dimmi quante persone, le date e cosa vuoi vivere. Ti rispondo con la proposta e i prezzi.', de: 'Sag mir, wie viele Personen, die Termine und was du erleben willst. Ich melde mich mit Vorschlag und Preis.', es: 'Cuéntame cuántas personas, las fechas y qué quieres vivir. Te respondo con la propuesta y los precios.' },
  waFalar:        { pt: 'Falar no WhatsApp', en: 'Message on WhatsApp', fr: 'Écrire sur WhatsApp', it: 'Scrivi su WhatsApp', de: 'Auf WhatsApp schreiben', es: 'Escribir por WhatsApp' },
  waSobConsulta:  { pt: 'Olá, Milla! Vim pelo app e quero saber mais sobre: {tour}', en: 'Hi Milla! I came from the app and I’d like to know more about: {tour}', fr: 'Bonjour Milla ! Je viens de l’app et j’aimerais en savoir plus sur : {tour}', it: 'Ciao Milla! Vengo dall’app e vorrei sapere di più su: {tour}', de: 'Hallo Milla! Ich komme aus der App und möchte mehr wissen über: {tour}', es: '¡Hola Milla! Vengo de la app y quiero saber más sobre: {tour}' },
  admDemoTit:  { pt: 'Conheça o painel do guia', en: 'See the guide’s panel', fr: 'Découvrez le panneau du guide', it: 'Scopri il pannello della guida', de: 'Das Panel des Guides ansehen', es: 'Conoce el panel del guía' },
