...
const VERSION = 'berlim-v0.6.2';
const CORE = [
  './', './index.html', './config.js', './app.js', './fx.js', './pix.js', './qr.js', './qrcode.js', './traduz.js', './idiomas.js', './store.js', './cores.js', './pedidos.js', './parceiros.js', './depoimentos.js', './assistente.js', './auth.js', './logo.js', './cloud.js', './i18n.js', './avisos.js', './creditos.js', './tokens.css', './fontes/arapey-regular.woff2', './fontes/arapey-italic.woff2', './fontes/instrument-serif-regular.woff2', './fontes/instrument-serif-italic.woff2',
