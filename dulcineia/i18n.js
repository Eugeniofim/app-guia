...
const STR = {
  ...
  /* enquanto todo passeio e sob consulta, "reserva na hora" seria promessa falsa */
  seeToursSubQ:{ pt: 'Roteiros, fotos e pedido de valores', en: 'Itineraries, photos and quotes', fr: 'Itinéraires, photos et devis',
                 it: 'Itinerari, foto e preventivi', de: 'Routen, Fotos und Angebote', es: 'Itinerarios, fotos y presupuestos' },
  ...
  /* Passeio sem valor (preço 0) = sob consulta: o card e a página mostram
     isso e a reserva vira conversa no WhatsApp. Nunca "€ 0". */
  onRequest:   { pt: 'Sob consulta', en: 'On request', fr: 'Sur demande', it: 'Su richiesta', de: 'Auf Anfrage', es: 'A consultar' },
  onRequestSub:{ pt: 'O valor depende do tamanho do grupo e da data. Me conte quem viaja e quando, e eu te respondo com a proposta.',
                 en: 'The price depends on group size and date. Tell me who is travelling and when, and I will reply with a quote.',
                 fr: 'Le prix dépend de la taille du groupe et de la date. Dites-moi qui voyage et quand, je vous réponds avec un devis.',
                 it: 'Il prezzo dipende dal numero di persone e dalla data. Dimmi chi viaggia e quando, e ti rispondo con un preventivo.',
                 de: 'Der Preis hängt von Gruppengröße und Datum ab. Sagen Sie mir, wer wann reist, und ich schicke Ihnen ein Angebot.',
                 es: 'El precio depende del tamaño del grupo y de la fecha. Cuéntame quién viaja y cuándo, y te respondo con una propuesta.' },
  askQuoteBtn: { pt: 'Pedir valores no WhatsApp', en: 'Ask for a quote on WhatsApp', fr: 'Demander un devis sur WhatsApp',
                 it: 'Chiedi un preventivo su WhatsApp', de: 'Angebot per WhatsApp anfragen', es: 'Pedir precio por WhatsApp' },
  waAskQuote:  { pt: 'Olá, {guia}! Vi a visita {tour} no app e queria saber valores e datas.',
                 en: 'Hi {guia}! I saw the {tour} tour on the app and would like to know prices and dates.',
                 fr: 'Bonjour {guia} ! J’ai vu la visite {tour} dans l’app et j’aimerais connaître les prix et les dates.',
                 it: 'Ciao {guia}! Ho visto la visita {tour} nell’app e vorrei sapere prezzi e date.',
                 de: 'Hallo {guia}! Ich habe die Führung {tour} in der App gesehen und hätte gern Preise und Termine.',
                 es: '¡Hola, {guia}! Vi la visita {tour} en la app y quería saber precios y fechas.' },
  dtTurno: { pt: 'Turno', en: 'Time slot', fr: 'Créneau', it: 'Turno', de: 'Zeitfenster', es: 'Turno' },
  dtTurnos: { pt: 'Turnos', en: 'Time slots', fr: 'Créneaux', it: 'Turni', de: 'Zeitfenster', es: 'Turnos' },
  dtEscolhaTurno: { pt: 'Marque pelo menos um turno.', en: 'Pick at least one time slot.', fr: 'Choisissez au moins un créneau.', it: 'Scegli almeno un turno.', de: 'Mindestens ein Zeitfenster wählen.', es: 'Marca al menos un turno.' },
  todosOsDias: { pt: 'Todos os dias', en: 'Every day', fr: 'Tous les jours', it: 'Tutti i giorni', de: 'Jeden Tag', es: 'Todos los días' },
  turnoFechadoTxt: { pt: 'fechado', en: 'closed', fr: 'fermé', it: 'chiuso', de: 'geschlossen', es: 'cerrado' },
  turnoFechar: { pt: 'Fechar turno', en: 'Close slot', fr: 'Fermer le créneau', it: 'Chiudi turno', de: 'Zeitfenster schließen', es: 'Cerrar turno' },
  turnoAbrir: { pt: 'Abrir turno', en: 'Open slot', fr: 'Ouvrir le créneau', it: 'Apri turno', de: 'Zeitfenster öffnen', es: 'Abrir turno' },
  turnoLancar: { pt: '+ Lançar reserva', en: '+ Add booking', fr: '+ Ajouter une réservation', it: '+ Aggiungi prenotazione', de: '+ Buchung eintragen', es: '+ Añadir reserva' },
  turnoJaOcupado: { pt: 'Esse turno já está ocupado nesse dia.', en: 'That slot is already taken on that day.', fr: 'Ce créneau est déjà pris ce jour-là.', it: 'Quel turno è già occupato in quel giorno.', de: 'Dieses Zeitfenster ist an dem Tag schon belegt.', es: 'Ese turno ya está ocupado ese día.' },
  turnoFechadoOk: { pt: 'Turno fechado — ninguém consegue pedir esse horário.', en: 'Slot closed — nobody can request it.', fr: 'Créneau fermé — personne ne peut le demander.', it: 'Turno chiuso — nessuno può richiederlo.', de: 'Zeitfenster geschlossen — niemand kann es anfragen.', es: 'Turno cerrado — nadie puede pedirlo.' },
  agLegendTurnos: { pt: 'Uma bolinha por turno: cheia = reservado, contorno = livre, apagada = fechado.', en: 'One dot per slot: filled = booked, outline = free, faded = closed.', fr: 'Un point par créneau : plein = réservé, contour = libre, pâle = fermé.', it: 'Un punto per turno: pieno = prenotato, contorno = libero, sbiadito = chiuso.', de: 'Ein Punkt pro Zeitfenster: voll = gebucht, Rand = frei, blass = geschlossen.', es: 'Un punto por turno: lleno = reservado, contorno = libre, apagado = cerrado.' },
  xRemover: { pt: 'Remover', en: 'Remove', fr: 'Supprimer', it: 'Rimuovi', de: 'Entfernen', es: 'Quitar' },
  fTurnos:     { pt: 'Horários', en: 'Time slots', fr: 'Horaires', it: 'Orari', de: 'Zeiten', es: 'Horarios' },
  turnoUmGrupo:{ pt: 'cada turno é só do seu grupo', en: 'each slot is just for your group', fr: 'chaque créneau est réservé à votre groupe',
                 it: 'ogni turno è solo per il tuo gruppo', de: 'jedes Zeitfenster nur für Ihre Gruppe', es: 'cada turno es solo para tu grupo' },
  maisDatas:   { pt: 'Mais datas', en: 'More dates', fr: 'Plus de dates', it: 'Altre date', de: 'Weitere Termine', es: 'Más fechas' },
  pickTurno:   { pt: 'Escolha o turno — cada um é só do seu grupo', en: 'Pick a time slot — each one is just for your group',
                 fr: 'Choisissez le créneau — il est réservé à votre groupe', it: 'Scegli il turno — è solo per il tuo gruppo',
                 de: 'Wählen Sie das Zeitfenster — nur für Ihre Gruppe', es: 'Elige el turno — es solo para tu grupo' },
  turnoLivre:  { pt: 'livre', en: 'available', fr: 'libre', it: 'libero', de: 'frei', es: 'libre' },
  turnoOcupado:{ pt: 'ocupado', en: 'taken', fr: 'occupé', it: 'occupato', de: 'belegt', es: 'ocupado' },
  askQuoteTurnoBtn: { pt: 'Pedir a proposta no WhatsApp', en: 'Ask for a quote on WhatsApp', fr: 'Demander un devis sur WhatsApp',
                 it: 'Chiedi il preventivo su WhatsApp', de: 'Angebot per WhatsApp anfragen', es: 'Pedir la propuesta por WhatsApp' },
  waAskQuoteTurno: { pt: 'Olá, {guia}! Vi a visita {tour} no app. Queria o dia {data}, turno da {turno}, para {n} pessoas. Pode me mandar a proposta?',
                 en: 'Hi {guia}! I saw the {tour} tour on the app. I would like {data}, {turno} slot, for {n} people. Could you send me a quote?',
                 fr: 'Bonjour {guia} ! J’ai vu la visite {tour} dans l’app. Je voudrais le {data}, créneau {turno}, pour {n} personnes. Pouvez-vous m’envoyer un devis ?',
                 it: 'Ciao {guia}! Ho visto la visita {tour} nell’app. Vorrei il {data}, turno {turno}, per {n} persone. Mi mandi un preventivo?',
                 de: 'Hallo {guia}! Ich habe die Führung {tour} in der App gesehen. Ich hätte gern den {data}, Zeitfenster {turno}, für {n} Personen. Können Sie mir ein Angebot schicken?',
                 es: '¡Hola, {guia}! Vi la visita {tour} en la app. Quería el día {data}, turno de {turno}, para {n} personas. ¿Me mandas la propuesta?' },
  privateTour: { pt: 'Privativo', en: 'Private', fr: 'Privé', it: 'Privato', de: 'Privat', es: 'Privado' },
  privateSub:  { pt: 'só o seu grupo', en: 'just your group', fr: 'votre groupe seulement', it: 'solo il tuo gruppo', de: 'nur Ihre Gruppe', es: 'solo tu grupo' },
  pickupHotel: { pt: 'Eu busco você no hotel', en: 'I pick you up at your hotel', fr: 'Je viens vous chercher à l’hôtel',
                 it: 'Ti vengo a prendere in hotel', de: 'Ich hole Sie im Hotel ab', es: 'Te busco en el hotel' },
  tPriceZero:  { pt: 'Deixe 0 para “sob consulta”: o cliente pede os valores no WhatsApp.',
                 en: 'Leave 0 for “on request”: the client asks for prices on WhatsApp.',
                 fr: 'Laissez 0 pour « sur demande » : le client demande les prix sur WhatsApp.',
                 it: 'Lascia 0 per “su richiesta”: il cliente chiede i prezzi su WhatsApp.',
                 de: '0 lassen für „auf Anfrage“: der Kunde fragt die Preise per WhatsApp an.',
                 es: 'Deja 0 para “a consultar”: el cliente pide los precios por WhatsApp.' },
  ...
  admAvisoHelp: { pt: 'Quando alguém reservar pelo app, chega um e-mail aqui com o passeio, a data, quantas pessoas e o contato. É só responder o e-mail que a resposta vai direto para o cliente.',
  ...
  admAvisoNota: { pt: 'O aviso sai na hora em que a reserva é gravada — por e-mail e, nos aparelhos ativados abaixo, como notificação.',
  ...
  admCliNota: { pt: 'O recibo sai sozinho. A confirmação só sai quando você apertar “Avisar cliente”, porque só você sabe se o dinheiro entrou. Na tarde anterior ao passeio, ele recebe sozinho um lembrete com a hora e a saída.',
  ...
  vPrice: { pt: 'O preço não pode ser negativo.', en: 'Price cannot be negative.' },
...
/* Linguas do app (config.js guia.linguas). Com uma so, ela manda: o app nao
   oferece seletor e ignora o que estiver salvo — a Conexao Berlim guia so em
   portugues, e um cliente com o celular em alemao tambem ve em portugues. */
function linguasApp() {
  const l = typeof APP_CONFIG !== 'undefined' && APP_CONFIG.guia && APP_CONFIG.guia.linguas;
  return Array.isArray(l) && l.length ? l : null;
}
function soUmaLingua() { const l = linguasApp(); return !!(l && l.length === 1); }
let LANG = (function () {
  if (soUmaLingua()) return linguasApp()[0];
  try { return JSON.parse(localStorage.getItem(DB_KEY))?.settings?.lang || 'pt'; } catch (e) { return 'pt'; }
})();
...
function setLang(l) { if (soUmaLingua()) return; LANG = l; DB.settings.lang = l; save(); }
