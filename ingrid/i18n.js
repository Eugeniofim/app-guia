...
const STR = {
  ...
  secStopsSub: { pt: '{n} paradas · {d} com a Ingrid', en: '{n} stops · {d} with Ingrid' },
  ...
  rtEnviar:   { pt: 'Enviar para a Ingrid no WhatsApp', en: 'Send to Ingrid on WhatsApp' },
  ...
  rtOkSub:    { pt: 'O WhatsApp abriu com tudo preenchido — é só tocar em enviar. A Ingrid responde com a proposta.',
                en: 'WhatsApp opened with everything filled in — just tap send. Ingrid will reply with a proposal.' },
  ...
  trfCentroWhy:{ pt: 'Se o hotel for fora do centro, ou o grupo se dividir em dois hotéis, a Ingrid faz o orçamento na hora pelo WhatsApp.',
  ...
  orcOi:       { pt: 'Olá, Ingrid! Queria um orçamento:', en: 'Hi Ingrid! I would like a quote:' },
